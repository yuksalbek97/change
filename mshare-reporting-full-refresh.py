...
# MAGIC %md ### CE Model Parameter - Preprocessing
...
### Transposing the 6 attribute values from columnwise to rowwise to make it easy to join with revenue_summary
spark.sql(
"""
...
from model_parameter a -- where scenario_id="0E15CA854B9C4587AF5E861D2FD271AB"
"""
).createOrReplaceTempView("model_parameter_unpivot")

# COMMAND ----------

# MAGIC %md ### CE Revenue Summary - Preprocessing
...
# MAGIC %md ###Reporting MShare Table - Full Refresh

# COMMAND ----------

from delta.tables import *

if DeltaTable.isDeltaTable(spark, dfm_reporting_path + "ce_t_mshare_rpt/"):    
    spark.sql("DELETE FROM reporting.ce_t_mshare_rpt`")
    dbutils.fs.rm(dfm_reporting_path + "ce_t_mshare_rpt/", True)

# COMMAND ----------

# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS reporting.ce_t_mshare_rpt;
# MAGIC
...
# DBTITLE 1,Delete existing records from reporting MShare table
# %sql
# delete from reporting.ce_t_mshare_rpt;
...
# %sql
# select * from reporting.ce_t_mshare_rpt where 
# scenario_id in
# (
# "B9FCFD97D76A43B48132D296E9243DF6",
# "6DB07B2DFB474545B40FF5CAA6575DDE",
# "E3F3C26C20CB45D4BF9AFAE9C97B8B9B",
# "412CA635E1054F1D85EBB426E29D8F0C",
# "6A73C65DCCFF4FCD83454E994068967C",
# "6831741AD37D469795B6E4EBF7720BC0",
# "301973B88DC84548B5CFDD1925F86FC1"
# )
